...
mean=zeros(m-1,n2-n1+n4-n3+2);
standdev=zeros(m-1,n2-n1+n4-n3+2);
Legendp=cell(10,1);
LegendN=cell(n2-n1+n4-n3+2,1);
for in=n1:n2
...
for in=n3:n4
    ...
    mean(:,in)=entxwps{in}(numener,:)/number;
    standdev(:,in)=entstdwps{in}(numener,:)/number;
    LegendN{in-n3+n2-n1+2}=['N = ' num2str(in)] ;
end
for pin=1:100:1000
...
figure(2)
plot(p(2:end),standdev(:,[n1:n2,n3:n4]));
legend(LegendN);
xlabel('parameter p','FontSize',20)
ylabel('P fraction of surviving species','FontSize',20)
...
figure(3)
plot([n1:n2,n3:n4],mean(1:100:1000,[n1:n2,n3:n4])');
legend(Legendp);
...
figure(4)
plot([n1:n2,n3:n4],standdev(1:100:1000,[n1:n2,n3:n4])');
legend(Legendp);
xlabel('Size N','FontSize',20)
ylabel('P fraction of surviving species)','FontSize',20)
