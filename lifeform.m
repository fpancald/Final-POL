function [sN,alive,talive]=lifeform(sn,p,conM,alpha)%N number of cell for individual, sN number of surviving cells and the end of the execution, alive=1 means survival alive=0 death, sn number of cell alive at begining feeding cycle, p number of pumps
N=length(conM);
